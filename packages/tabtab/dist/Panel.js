...
const PanelStyle = styled_components_1.default.div `
...
class PanelComponent extends React.PureComponent {
    render() {
        ...
        return (React.createElement(Panel, { role: "tabpanel", id: `react-tabtab-panel-${index}`, "aria-labelledby": `react-tabtab-${index}`, "aria-hidden": false, active: active }, active ?
            this.props.children
            : null));
    }
}
