...
var SortMethod = (function (_super) {
...
var ModalTabListWrapper = (function (_super) {
    ...
    ModalTabListWrapper.prototype.render = function () {
        return (React__namespace.createElement(DragTabContainer$1, { onSortEnd: this.onSortEnd, axis: 'y', lockAxis: 'y', pressDelay: 100 }, this.props.children));
    };
...
var DragTabList = (function (_super) {
    ...
    DragTabList.prototype.render = function () {
        ...
        return (React__default["default"].createElement(DragTabContainer, tslib.__assign({ onSortEnd: this.onSortEnd, axis: 'x', lockAxis: 'x', pressDelay: 100 }, props), children));
    };
    return DragTabList;
}(SortMethod));
...
var DragTabElement = reactSortableHoc.SortableElement(function (_a) {
    var children = _a.children, props = tslib.__rest(_a, ["children"]);
    return (React__namespace.createElement(Tab, tslib.__assign({}, props, { index: props.tabIndex }), children));
});
var DragTab = (function (_super) {
