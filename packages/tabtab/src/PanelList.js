...
var PanelList = (function (_super) {
    ...
    PanelList.prototype.render = function () {
        ...
        if (customStyle && customStyle.Panel) {
            props = __assign(__assign({}, props), { CustomPanelStyle: customStyle.Panel });
        }
        var result = React.Children.toArray(children).map(function (child, index) { return (React.cloneElement(child, __assign({ key: index, active: index === activeIndex, index: index }, props))); });
